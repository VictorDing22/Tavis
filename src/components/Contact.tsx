        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 max-w-[900px] mx-auto">
          ...
          <form onSubmit={handleSubmit} className="order-2 md:order-1">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full bg-primary text-white text-sm font-medium hover:bg-neutral-800 active:scale-[0.98] transition-all min-h-[48px] disabled:opacity-60 disabled:pointer-events-none"
            >
              {status === "loading" ? (
                <>
...
function ContactItem({
  ...
  return (
    <div className="flex items-start gap-4">
      <div className="text-secondary mt-0.5 shrink-0">{icon}</div>
      <div>
